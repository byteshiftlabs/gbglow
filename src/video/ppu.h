...
private:
    ...
    void check_stat_interrupt(u8 stat_enable_bit);  // Fire STAT interrupt if given enable bit is set
    void update_lyc_coincidence();                   // Sync LYC=LY flag and fire if enabled
};
